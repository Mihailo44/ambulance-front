    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            buildFormattedTextField(context, "Firstname", _firstnameController.text),
            buildFormattedTextField(context, "Lastname", _lastnameController.text),
            buildFormattedTextField(context, "Date of Birth", _dateOfBirthController.text.substring(0,10)),
            buildFormattedTextField(context, "Password", _passwordController.text),
            buildFormattedTextField(context, "Contact Number", _contactController.text),
            buildFormattedTextField(context, "Emergency Contact", _emergencyContactController.text),
            const Spacer(),
            Center(
